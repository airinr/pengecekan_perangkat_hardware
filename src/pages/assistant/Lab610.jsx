...
// === KONSTAN KODE ===
const LAB_CODE = "LAB00002"; // halaman ini khusus Lab 610
  ...
  return (
    <div className="mx-auto px-4 py-8 lg:ml-56">
      ...
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold mb-2">Perangkat Laboratorium 610</h1>
        <p className="text-sm text-slate-300 mb-6">
          Kode Lab: <span className="font-semibold">Lab 610</span>. Pilih salah
